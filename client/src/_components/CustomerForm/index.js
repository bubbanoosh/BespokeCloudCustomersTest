                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    <div className="form-row">
                        <div className="form-group col-md-6">
                            ...
                            <input type="text" className="form-control" name="firstName" id="firstName"
                                placeholder="Given name" value={customer.firstName || ''} onChange={this.handleChange} disabled={formState}
                            />
                        </div>
                        <div className="form-group col-md-6">
                            <label htmlFor="lastName">Surname</label>
                            <input type="text" className="form-control" name="lastName" id="lastName"
                                placeholder="Surname" value={customer.lastName || ''} onChange={this.handleChange} disabled={formState}
                            />
                        </div>
                    </div>
                    <div className="form-group">
                        ...
                        <input type="email" className="form-control" name="email" id="email"
                            placeholder="name@domain.com" value={customer.email || ''} onChange={this.handleChange} disabled={formState}
                        />
                    </div>
